    ...
    public void setAudioPlayByEarPhone(int state) {
        ...
        if (state == 0) {
            ...
            audioManager.setStreamVolume(AudioManager.STREAM_VOICE_CALL,
                    audioManager.getStreamMaxVolume(AudioManager.STREAM_VOICE_CALL), AudioManager.FLAG_SHOW_UI|AudioManager.FLAG_PLAY_SOUND);
        } else {
            mIsEarPhoneOn = true;
            audioManager.setSpeakerphoneOn(false);
            audioManager.setStreamVolume(AudioManager.STREAM_VOICE_CALL, currVolume, AudioManager.FLAG_SHOW_UI|AudioManager.FLAG_PLAY_SOUND);
        }
    }
