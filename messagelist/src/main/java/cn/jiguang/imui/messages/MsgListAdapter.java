...
public class MsgListAdapter<MESSAGE extends IMessage> extends RecyclerView.Adapter<ViewHolder>
    ...
    public int getItemViewType(int position) {
        ...
        if (wrapper.item instanceof IMessage) {
            ...
            if (message.getMessageType() == IMessage.MessageType.EVENT.ordinal()) {
                return TYPE_EVENT;
            } else if (message.getMessageType() == IMessage.MessageType.SEND_TEXT.ordinal()) {
                return TYPE_SEND_TXT;
            } else if (message.getMessageType() == IMessage.MessageType.RECEIVE_TEXT.ordinal()) {
                return TYPE_RECEIVE_TXT;
            } else if (message.getMessageType() == IMessage.MessageType.SEND_IMAGE.ordinal()) {
                return TYPE_SEND_IMAGE;
            } else if (message.getMessageType() == IMessage.MessageType.RECEIVE_IMAGE.ordinal()) {
                return TYPE_RECEIVER_IMAGE;
            } else if (message.getMessageType() == IMessage.MessageType.SEND_VOICE.ordinal()) {
                return TYPE_SEND_VOICE;
            } else if (message.getMessageType() == IMessage.MessageType.RECEIVE_VOICE.ordinal()) {
                return TYPE_RECEIVER_VOICE;
            } else if (message.getMessageType() == IMessage.MessageType.SEND_VIDEO.ordinal()) {
                return TYPE_SEND_VIDEO;
            } else if (message.getMessageType() == IMessage.MessageType.RECEIVE_VIDEO.ordinal()) {
                return TYPE_RECEIVE_VIDEO;
            } else if (message.getMessageType() == IMessage.MessageType.SEND_LOCATION.ordinal()) {
                return TYPE_SEND_LOCATION;
            } else if (message.getMessageType() == IMessage.MessageType.RECEIVE_LOCATION.ordinal()) {
    ...
    private int getCustomType(IMessage message) {
        for (int i = 0; i < mCustomMsgList.size(); i++) {
            ...
            if (message.getMessageType() == config.getViewType()) {
